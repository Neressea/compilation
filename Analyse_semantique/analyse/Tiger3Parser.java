package analyse;
// $ANTLR 3.5.1 D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g 2016-03-31 15:48:26
...
public class Tiger3Parser extends Parser {
	public static final String[] tokenNames = new String[] {
		...
		"COMMENT2", "COMP", "COND", "CONST", "DECLARATIONS", "EMPTY_SEQ", "END", 
		"FIELD", "FUNC_CALL", "FUNC_DECL", "ID", "IDF", "INIT", "INT", "NEG", 
		"NEWLINE", "PARAM", "PARAMSEFF", "PARAMSFORM", "PRIMITIF", "SIZE", "STRING", 
		"STRUCT", "TAB", "TAIGA", "TYPE", "WS", "'&'", "'('", "')'", "'*'", "'+'", 
		"','", "'-'", "'.'", "'/'", "':'", "':='", "';'", "'<'", "'='", "'>'", 
		...
		try {
			...
			switch (alt5) {
				...
				case 3 :
					...
					switch (alt2) {
						case 1 :
							...
							{
							char_literal4=(Token)match(input,74,FOLLOW_74_in_expr153); 
							...
							char_literal6=(Token)match(input,76,FOLLOW_76_in_expr158); 
				...
				case 8 :
					...
					if ( (LA4_0==ID||LA4_0==INT||LA4_0==STRING||LA4_0==36||LA4_0==41||LA4_0==55||LA4_0==59||LA4_0==61||(LA4_0 >= 63 && LA4_0 <= 65)||LA4_0==67||LA4_0==73) ) {
						alt4=1;
					}
					switch (alt4) {
						case 1 :
		...
		try {
			...
			switch (alt6) {
				case 1 :
					...
					{
					char_literal13=(Token)match(input,40,FOLLOW_40_in_expr_list246);  
		...
		try {
			...
			switch (alt7) {
				case 1 :
					...
					{
					pv=(Token)match(input,46,FOLLOW_46_in_expr_seq284);  
					stream_46.add(pv);
	...
	public final Tiger3Parser.field_list_return field_list() throws RecognitionException {
		...
		try {
			...
			string_literal14=(Token)match(input,45,FOLLOW_45_in_field_list319);  
			...
			switch (alt8) {
				case 1 :
					...
					{
					v=(Token)match(input,40,FOLLOW_40_in_field_list328);  
					stream_40.add(v);
	...
	public final Tiger3Parser.forop_return forop() throws RecognitionException {
		...
		try {
			...
			string_literal15=(Token)match(input,45,FOLLOW_45_in_forop472);  
		...
		try {
			...
			switch (alt10) {
				case 1 :
					...
					{
					af=(Token)match(input,45,FOLLOW_45_in_affect599);  
					stream_45.add(af);
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					ortoken=(Token)match(input,75,FOLLOW_75_in_orop648); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					andtoken=(Token)match(input,35,FOLLOW_35_in_andop671); 
	...
	public final Tiger3Parser.comp_return comp() throws RecognitionException {
		...
		try {
				...
				case 1 :
					...
					switch (alt15) {
						case 1 :
							...
							{
							sup1=(Token)match(input,49,FOLLOW_49_in_comp694);  
							stream_49.add(sup1);
							...
							switch (alt13) {
								case 1 :
									...
									{
									eg1=(Token)match(input,48,FOLLOW_48_in_comp698);  
									stream_48.add(eg1);
						...
						case 2 :
							...
							{
							inf1=(Token)match(input,47,FOLLOW_47_in_comp706);  
							stream_47.add(inf1);
							...
							switch (alt14) {
								case 1 :
									...
									{
									sup2=(Token)match(input,49,FOLLOW_49_in_comp711);  
									stream_49.add(sup2);
								...
								case 2 :
									...
									{
									eg2=(Token)match(input,48,FOLLOW_48_in_comp717);  
									stream_48.add(eg2);
						...
						case 3 :
							...
							{
							eg3=(Token)match(input,48,FOLLOW_48_in_comp725);  
							stream_48.add(eg3);
			...
			// AST REWRITE
			// elements: inf1, b2, b1, b2, b1, b2, b1, b1, sup1, b2, b1, b2, eg3, b1, b2, b1
				...
				case 1 :
					...
					switch (alt18) {
						case 1 :
							...
							{
							mul=(Token)match(input,38,FOLLOW_38_in_binary2900); 
						...
						case 2 :
							...
							{
							div=(Token)match(input,43,FOLLOW_43_in_binary2905); 
		...
		try {
			...
			switch (alt20) {
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:111:12: minus= '-'
					{
					minus=(Token)match(input,41,FOLLOW_41_in_neg923);  
					stream_41.add(minus);
		...
		try {
			...
			switch (alt22) {
				case 1 :
					...
					{
					char_literal23=(Token)match(input,36,FOLLOW_36_in_atom963);  
					stream_36.add(char_literal23);

					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:116:13: (e= expr_seq )?
					int alt21=2;
					int LA21_0 = input.LA(1);
					if ( (LA21_0==ID||LA21_0==INT||LA21_0==STRING||LA21_0==36||LA21_0==41||LA21_0==55||LA21_0==59||LA21_0==61||(LA21_0 >= 63 && LA21_0 <= 65)||LA21_0==67||LA21_0==73) ) {
						alt21=1;
					}
					switch (alt21) {
						case 1 :
					...
					char_literal24=(Token)match(input,37,FOLLOW_37_in_atom970);  
		...
		try {
			...
			switch (alt25) {
				...
				case 2 :
					...
					{
					par=(Token)match(input,36,FOLLOW_36_in_lvalue1028);  
					stream_36.add(par);

					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:124:37: (e= expr_list )?
					int alt23=2;
					int LA23_0 = input.LA(1);
					if ( (LA23_0==ID||LA23_0==INT||LA23_0==STRING||LA23_0==36||LA23_0==41||LA23_0==55||LA23_0==59||LA23_0==61||(LA23_0 >= 63 && LA23_0 <= 65)||LA23_0==67||LA23_0==73) ) {
						alt23=1;
					}
					switch (alt23) {
						case 1 :
					...
					char_literal28=(Token)match(input,37,FOLLOW_37_in_lvalue1035);  
				...
				case 3 :
					...
					{
					acc=(Token)match(input,74,FOLLOW_74_in_lvalue1041);  
					stream_74.add(acc);
					...
					char_literal29=(Token)match(input,76,FOLLOW_76_in_lvalue1048);  
					stream_76.add(char_literal29);
		...
		try {
			...
			switch (alt28) {
				case 1 :
					...
					{
					char_literal30=(Token)match(input,42,FOLLOW_42_in_lvalue21140);  
				...
				case 2 :
					...
					{
					char_literal32=(Token)match(input,50,FOLLOW_50_in_lvalue21164);  
					...
					stream_expr.add(e1.getTree());
					char_literal33=(Token)match(input,51,FOLLOW_51_in_lvalue21170);  
	...
	public final Tiger3Parser.declaration_list_return declaration_list() throws RecognitionException {
		...
		try {
			...
			if ( (LA29_0==60||LA29_0==70||LA29_0==72) ) {
				alt29=1;
			}
			switch (alt29) {
				case 1 :
	...
	public final Tiger3Parser.type_declaration_return type_declaration() throws RecognitionException {
		...
		try {
			...
			char_literal37=(Token)match(input,48,FOLLOW_48_in_type_declaration1317);  
	...
	// $ANTLR start "type"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:153:1: type : ( ( ID |t= type_id ) -> {$t.tree != null}? ^( PRIMITIF $t) -> ^( PRIMITIF ID ) | '{' (t= type_fields )? '}' -> {$t.tree != null}? ^( STRUCT $t) -> ^( STRUCT ) | 'array of' (t= type_id |i= ID ) -> {$t.text != null}? ^( TAB $t) -> ^( TAB $i) );
	public final Tiger3Parser.type_return type() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:153:6: ( ( ID |t= type_id ) -> {$t.tree != null}? ^( PRIMITIF $t) -> ^( PRIMITIF ID ) | '{' (t= type_fields )? '}' -> {$t.tree != null}? ^( STRUCT $t) -> ^( STRUCT ) | 'array of' (t= type_id |i= ID ) -> {$t.text != null}? ^( TAB $t) -> ^( TAB $i) )
			int alt34=3;
			switch ( input.LA(1) ) {
			case ID:
			case 63:
			...
			switch (alt34) {
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:153:8: ( ID |t= type_id )
					{
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:153:8: ( ID |t= type_id )
					int alt31=2;
					...
					switch (alt31) {
						case 1 :
							// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:153:9: ID
							{
							ID38=(Token)match(input,ID,FOLLOW_ID_in_type1349);  
							stream_ID.add(ID38);

							}
							break;
						case 2 :
							// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:153:14: t= type_id
							{
							pushFollow(FOLLOW_type_id_in_type1355);
							t=type_id();
							state._fsp--;
					...
					root_0 = (Object)adaptor.nil();
					// 154:4: -> {$t.tree != null}? ^( PRIMITIF $t)
					if ((t!=null?((Object)t.getTree()):null) != null) {
						// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:154:26: ^( PRIMITIF $t)
						{
						Object root_1 = (Object)adaptor.nil();
					...
					else // 155:4: -> ^( PRIMITIF ID )
					{
						// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:155:7: ^( PRIMITIF ID )
						{
						Object root_1 = (Object)adaptor.nil();
						root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(PRIMITIF, "PRIMITIF"), root_1);
						adaptor.addChild(root_1, stream_ID.nextNode());
					...
					break;
				case 2 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:156:4: '{' (t= type_fields )? '}'
					{
					char_literal39=(Token)match(input,74,FOLLOW_74_in_type1386);  
					stream_74.add(char_literal39);

					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:156:9: (t= type_fields )?
					int alt32=2;
					...
					switch (alt32) {
						case 1 :
							// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:156:9: t= type_fields
							{
							pushFollow(FOLLOW_type_fields_in_type1390);
							t=type_fields();
							state._fsp--;
					...
					char_literal40=(Token)match(input,76,FOLLOW_76_in_type1393);  
					...
					root_0 = (Object)adaptor.nil();
					// 157:4: -> {$t.tree != null}? ^( STRUCT $t)
					if ((t!=null?((Object)t.getTree()):null) != null) {
						// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:157:26: ^( STRUCT $t)
						{
						Object root_1 = (Object)adaptor.nil();
					...
					{
						// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:158:7: ^( STRUCT )
						{
						Object root_1 = (Object)adaptor.nil();
						root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(STRUCT, "STRUCT"), root_1);
						adaptor.addChild(root_0, root_1);
					...
					break;
				case 3 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:159:4: 'array of' (t= type_id |i= ID )
					{
					string_literal41=(Token)match(input,52,FOLLOW_52_in_type1423);  
					stream_52.add(string_literal41);

					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:159:15: (t= type_id |i= ID )
					int alt33=2;
					int LA33_0 = input.LA(1);
					if ( (LA33_0==63||LA33_0==67) ) {
						alt33=1;
					}
					else if ( (LA33_0==ID) ) {
						alt33=2;
					...
					switch (alt33) {
						case 1 :
							// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:159:16: t= type_id
							{
							pushFollow(FOLLOW_type_id_in_type1428);
							t=type_id();
							state._fsp--;
							...
							break;
						case 2 :
							// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:159:28: i= ID
							{
					...
					root_0 = (Object)adaptor.nil();
					// 160:4: -> {$t.text != null}? ^( TAB $t)
					if ((t!=null?input.toString(t.start,t.stop):null) != null) {
						// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:160:26: ^( TAB $t)
						{
						Object root_1 = (Object)adaptor.nil();
					...
					{
						// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:161:7: ^( TAB $i)
						{
						Object root_1 = (Object)adaptor.nil();
						root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(TAB, "TAB"), root_1);
						adaptor.addChild(root_1, stream_i.nextNode());
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:164:1: variable_declaration : vava= varexp nom= ID (depoi= ':' (typenew= ID |typebase= type_id ) )? ':=' e= expr -> {$depoi != null && $typenew.text!=null}? ^( $vava $nom $typenew $e) -> {$depoi != null && $typebase.text!=null}? ^( $vava $nom $typebase $e) -> ^( $vava $nom $e) ;
	public final Tiger3Parser.variable_declaration_return variable_declaration() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:165:2: (vava= varexp nom= ID (depoi= ':' (typenew= ID |typebase= type_id ) )? ':=' e= expr -> {$depoi != null && $typenew.text!=null}? ^( $vava $nom $typenew $e) -> {$depoi != null && $typebase.text!=null}? ^( $vava $nom $typebase $e) -> ^( $vava $nom $e) )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:165:4: vava= varexp nom= ID (depoi= ':' (typenew= ID |typebase= type_id ) )? ':=' e= expr
			{
			pushFollow(FOLLOW_varexp_in_variable_declaration1474);
			vava=varexp();
			state._fsp--;

			stream_varexp.add(vava.getTree());
			nom=(Token)match(input,ID,FOLLOW_ID_in_variable_declaration1478);  
			stream_ID.add(nom);

			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:165:23: (depoi= ':' (typenew= ID |typebase= type_id ) )?
			int alt36=2;
			...
			switch (alt36) {
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:165:25: depoi= ':' (typenew= ID |typebase= type_id )
					{
					depoi=(Token)match(input,44,FOLLOW_44_in_variable_declaration1484);  
					stream_44.add(depoi);

					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:165:35: (typenew= ID |typebase= type_id )
					int alt35=2;
					int LA35_0 = input.LA(1);
					if ( (LA35_0==ID) ) {
						alt35=1;
					}
					else if ( (LA35_0==63||LA35_0==67) ) {
						alt35=2;
					}
					...
					switch (alt35) {
						case 1 :
							// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:165:36: typenew= ID
							{
							typenew=(Token)match(input,ID,FOLLOW_ID_in_variable_declaration1489);  
							stream_ID.add(typenew);

							}
							break;
						case 2 :
							// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:165:49: typebase= type_id
							{
							pushFollow(FOLLOW_type_id_in_variable_declaration1495);
							typebase=type_id();
							state._fsp--;
			...
			string_literal42=(Token)match(input,45,FOLLOW_45_in_variable_declaration1500);  
			stream_45.add(string_literal42);

			pushFollow(FOLLOW_expr_in_variable_declaration1504);
			e=expr();
			state._fsp--;

			stream_expr.add(e.getTree());
			// AST REWRITE
			// elements: typenew, e, vava, nom, vava, nom, typebase, nom, vava, e, e
			...
			root_0 = (Object)adaptor.nil();
			// 166:5: -> {$depoi != null && $typenew.text!=null}? ^( $vava $nom $typenew $e)
			if (depoi != null && (typenew!=null?typenew.getText():null)!=null) {
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:166:49: ^( $vava $nom $typenew $e)
				{
				Object root_1 = (Object)adaptor.nil();
			...
			else // 167:5: -> {$depoi != null && $typebase.text!=null}? ^( $vava $nom $typebase $e)
			if (depoi != null && (typebase!=null?input.toString(typebase.start,typebase.stop):null)!=null) {
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:167:50: ^( $vava $nom $typebase $e)
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot(stream_vava.nextNode(), root_1);
				adaptor.addChild(root_1, stream_nom.nextNode());
			...
			else // 168:5: -> ^( $vava $nom $e)
			{
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:168:8: ^( $vava $nom $e)
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot(stream_vava.nextNode(), root_1);
				adaptor.addChild(root_1, stream_nom.nextNode());
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:171:1: function_declaration : functionexp ID '(' (par= type_fields )? ')' ( ':' (ty= type_id |i= ID ) )? '=' (e= expr )+ -> {$par.text != null && $ty.text != null}? ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( TYPE $ty) ^( BLOCK $e) ) -> {$par.text != null && $i != null}? ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( TYPE $i) ^( BLOCK $e) ) -> {$par.text != null}? ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( BLOCK $e) ) -> {$ty.text != null}? ^( FUNC_DECL ID ^( TYPE $ty) ^( BLOCK $e) ) -> {$i != null}? ^( FUNC_DECL ID ^( TYPE $i) ^( BLOCK $e) ) -> ^( FUNC_DECL ID ^( BLOCK $e) ) ;
	public final Tiger3Parser.function_declaration_return function_declaration() throws RecognitionException {
		...
		ParserRuleReturnScope e =null;
		ParserRuleReturnScope functionexp43 =null;
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:2: ( functionexp ID '(' (par= type_fields )? ')' ( ':' (ty= type_id |i= ID ) )? '=' (e= expr )+ -> {$par.text != null && $ty.text != null}? ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( TYPE $ty) ^( BLOCK $e) ) -> {$par.text != null && $i != null}? ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( TYPE $i) ^( BLOCK $e) ) -> {$par.text != null}? ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( BLOCK $e) ) -> {$ty.text != null}? ^( FUNC_DECL ID ^( TYPE $ty) ^( BLOCK $e) ) -> {$i != null}? ^( FUNC_DECL ID ^( TYPE $i) ^( BLOCK $e) ) -> ^( FUNC_DECL ID ^( BLOCK $e) ) )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:4: functionexp ID '(' (par= type_fields )? ')' ( ':' (ty= type_id |i= ID ) )? '=' (e= expr )+
			{
			pushFollow(FOLLOW_functionexp_in_function_declaration1578);
			functionexp43=functionexp();
			state._fsp--;

			stream_functionexp.add(functionexp43.getTree());
			ID44=(Token)match(input,ID,FOLLOW_ID_in_function_declaration1580);  
			stream_ID.add(ID44);

			char_literal45=(Token)match(input,36,FOLLOW_36_in_function_declaration1582);  
			stream_36.add(char_literal45);

			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:26: (par= type_fields )?
			int alt37=2;
			...
			switch (alt37) {
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:26: par= type_fields
					{
					pushFollow(FOLLOW_type_fields_in_function_declaration1586);
					par=type_fields();
					state._fsp--;
			...
			char_literal46=(Token)match(input,37,FOLLOW_37_in_function_declaration1589);  
			stream_37.add(char_literal46);

			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:44: ( ':' (ty= type_id |i= ID ) )?
			int alt39=2;
			...
			switch (alt39) {
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:45: ':' (ty= type_id |i= ID )
					{
					char_literal47=(Token)match(input,44,FOLLOW_44_in_function_declaration1592);  
					stream_44.add(char_literal47);

					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:49: (ty= type_id |i= ID )
					int alt38=2;
					int LA38_0 = input.LA(1);
					if ( (LA38_0==63||LA38_0==67) ) {
						alt38=1;
					}
					else if ( (LA38_0==ID) ) {
						alt38=2;
					...
					switch (alt38) {
						case 1 :
							// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:50: ty= type_id
							{
							pushFollow(FOLLOW_type_id_in_function_declaration1597);
							ty=type_id();
							state._fsp--;
							...
							break;
						case 2 :
							// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:61: i= ID
							{
							i=(Token)match(input,ID,FOLLOW_ID_in_function_declaration1601);  
							stream_ID.add(i);
			...
			char_literal48=(Token)match(input,48,FOLLOW_48_in_function_declaration1607);  
			stream_48.add(char_literal48);

			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:76: (e= expr )+
			int cnt40=0;
			loop40:
			while (true) {
				int alt40=2;
				int LA40_0 = input.LA(1);
				if ( (LA40_0==ID||LA40_0==INT||LA40_0==STRING||LA40_0==36||LA40_0==41||LA40_0==55||LA40_0==59||LA40_0==61||(LA40_0 >= 63 && LA40_0 <= 65)||LA40_0==67||LA40_0==73) ) {
					alt40=1;
				}

				switch (alt40) {
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:172:77: e= expr
					{
					pushFollow(FOLLOW_expr_in_function_declaration1614);
					e=expr();
					state._fsp--;
			...
			// AST REWRITE
			// elements: ID, e, e, par, ID, ID, par, i, e, i, e, ty, ID, e, ID, e, ty, par, ID
			// token labels: i
			...
			root_0 = (Object)adaptor.nil();
			// 173:4: -> {$par.text != null && $ty.text != null}? ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( TYPE $ty) ^( BLOCK $e) )
			if ((par!=null?input.toString(par.start,par.stop):null) != null && (ty!=null?input.toString(ty.start,ty.stop):null) != null) {
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:173:48: ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( TYPE $ty) ^( BLOCK $e) )
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(FUNC_DECL, "FUNC_DECL"), root_1);
				adaptor.addChild(root_1, stream_ID.nextNode());
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:173:63: ^( PARAMSFORM $par)
				{
				Object root_2 = (Object)adaptor.nil();
				...
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:173:82: ^( TYPE $ty)
				{
				Object root_2 = (Object)adaptor.nil();
				...
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:173:94: ^( BLOCK $e)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(BLOCK, "BLOCK"), root_2);
				adaptor.addChild(root_2, stream_e.nextTree());
			...
			else // 174:4: -> {$par.text != null && $i != null}? ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( TYPE $i) ^( BLOCK $e) )
			if ((par!=null?input.toString(par.start,par.stop):null) != null && i != null) {
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:174:42: ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( TYPE $i) ^( BLOCK $e) )
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(FUNC_DECL, "FUNC_DECL"), root_1);
				adaptor.addChild(root_1, stream_ID.nextNode());
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:174:57: ^( PARAMSFORM $par)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(PARAMSFORM, "PARAMSFORM"), root_2);
				adaptor.addChild(root_2, stream_par.nextTree());
				...
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:174:76: ^( TYPE $i)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(TYPE, "TYPE"), root_2);
				...
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:174:87: ^( BLOCK $e)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(BLOCK, "BLOCK"), root_2);
				adaptor.addChild(root_2, stream_e.nextTree());
			...
			else // 175:4: -> {$par.text != null}? ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( BLOCK $e) )
			if ((par!=null?input.toString(par.start,par.stop):null) != null) {
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:175:28: ^( FUNC_DECL ID ^( PARAMSFORM $par) ^( BLOCK $e) )
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(FUNC_DECL, "FUNC_DECL"), root_1);
				adaptor.addChild(root_1, stream_ID.nextNode());
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:175:43: ^( PARAMSFORM $par)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(PARAMSFORM, "PARAMSFORM"), root_2);
				adaptor.addChild(root_2, stream_par.nextTree());
				...
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:175:62: ^( BLOCK $e)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(BLOCK, "BLOCK"), root_2);
				adaptor.addChild(root_2, stream_e.nextTree());
			...
			else // 176:4: -> {$ty.text != null}? ^( FUNC_DECL ID ^( TYPE $ty) ^( BLOCK $e) )
			if ((ty!=null?input.toString(ty.start,ty.stop):null) != null) {
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:176:27: ^( FUNC_DECL ID ^( TYPE $ty) ^( BLOCK $e) )
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(FUNC_DECL, "FUNC_DECL"), root_1);
				adaptor.addChild(root_1, stream_ID.nextNode());
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:176:42: ^( TYPE $ty)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(TYPE, "TYPE"), root_2);
				adaptor.addChild(root_2, stream_ty.nextTree());
				...
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:176:54: ^( BLOCK $e)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(BLOCK, "BLOCK"), root_2);
				adaptor.addChild(root_2, stream_e.nextTree());
			...
			else // 177:4: -> {$i != null}? ^( FUNC_DECL ID ^( TYPE $i) ^( BLOCK $e) )
			if (i != null) {
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:177:21: ^( FUNC_DECL ID ^( TYPE $i) ^( BLOCK $e) )
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(FUNC_DECL, "FUNC_DECL"), root_1);
				adaptor.addChild(root_1, stream_ID.nextNode());
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:177:36: ^( TYPE $i)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(TYPE, "TYPE"), root_2);
				adaptor.addChild(root_2, stream_i.nextNode());
				...
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:177:47: ^( BLOCK $e)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(BLOCK, "BLOCK"), root_2);
				adaptor.addChild(root_2, stream_e.nextTree());
			...
			else // 178:4: -> ^( FUNC_DECL ID ^( BLOCK $e) )
			{
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:178:7: ^( FUNC_DECL ID ^( BLOCK $e) )
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(FUNC_DECL, "FUNC_DECL"), root_1);
				adaptor.addChild(root_1, stream_ID.nextNode());
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:178:22: ^( BLOCK $e)
				{
				Object root_2 = (Object)adaptor.nil();
				root_2 = (Object)adaptor.becomeRoot((Object)adaptor.create(BLOCK, "BLOCK"), root_2);
				adaptor.addChild(root_2, stream_e.nextTree());
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:181:1: type_fields : t1= type_field (t2= type_fields2 )? -> $t1 ( $t2)? ;
	public final Tiger3Parser.type_fields_return type_fields() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:181:13: (t1= type_field (t2= type_fields2 )? -> $t1 ( $t2)? )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:181:15: t1= type_field (t2= type_fields2 )?
			{
			pushFollow(FOLLOW_type_field_in_type_fields1798);
			t1=type_field();
			state._fsp--;

			stream_type_field.add(t1.getTree());
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:181:31: (t2= type_fields2 )?
			int alt41=2;
			...
			switch (alt41) {
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:181:31: t2= type_fields2
					{
					pushFollow(FOLLOW_type_fields2_in_type_fields1802);
					t2=type_fields2();
					state._fsp--;
			...
			// 182:4: -> $t1 ( $t2)?
			{
				...
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:182:12: ( $t2)?
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:185:1: type_fields2 : ',' t1= type_field (t2= type_fields2 )? -> $t1 ( $t2)? ;
	public final Tiger3Parser.type_fields2_return type_fields2() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:185:14: ( ',' t1= type_field (t2= type_fields2 )? -> $t1 ( $t2)? )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:185:16: ',' t1= type_field (t2= type_fields2 )?
			{
			char_literal49=(Token)match(input,40,FOLLOW_40_in_type_fields21826);  
			stream_40.add(char_literal49);

			pushFollow(FOLLOW_type_field_in_type_fields21830);
			t1=type_field();
			state._fsp--;

			stream_type_field.add(t1.getTree());
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:185:36: (t2= type_fields2 )?
			int alt42=2;
			...
			switch (alt42) {
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:185:36: t2= type_fields2
					{
					pushFollow(FOLLOW_type_fields2_in_type_fields21834);
					t2=type_fields2();
					state._fsp--;
			...
			{
				adaptor.addChild(root_0, stream_t1.nextTree());
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:186:12: ( $t2)?
				if ( stream_t2.hasNext() ) {
					adaptor.addChild(root_0, stream_t2.nextTree());
				}
				stream_t2.reset();
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:189:1: type_field : i1= ID ':' (t= type_id |i2= ID ) -> {$i2.text != null}? ^( PARAM[\"p\"] $i1 $i2) -> ^( PARAM[\"p\"] $i1 $t) ;
	public final Tiger3Parser.type_field_return type_field() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:189:12: (i1= ID ':' (t= type_id |i2= ID ) -> {$i2.text != null}? ^( PARAM[\"p\"] $i1 $i2) -> ^( PARAM[\"p\"] $i1 $t) )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:189:14: i1= ID ':' (t= type_id |i2= ID )
			{
			i1=(Token)match(input,ID,FOLLOW_ID_in_type_field1860);  
			stream_ID.add(i1);

			char_literal50=(Token)match(input,44,FOLLOW_44_in_type_field1862);  
			stream_44.add(char_literal50);

			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:189:24: (t= type_id |i2= ID )
			int alt43=2;
			int LA43_0 = input.LA(1);
			if ( (LA43_0==63||LA43_0==67) ) {
				alt43=1;
			}
			else if ( (LA43_0==ID) ) {
				alt43=2;
			...
			switch (alt43) {
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:189:25: t= type_id
					{
					pushFollow(FOLLOW_type_id_in_type_field1867);
					t=type_id();
					state._fsp--;
					...
					break;
				case 2 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:189:35: i2= ID
					{
					i2=(Token)match(input,ID,FOLLOW_ID_in_type_field1871);  
					stream_ID.add(i2);
			...
			root_0 = (Object)adaptor.nil();
			// 190:4: -> {$i2.text != null}? ^( PARAM[\"p\"] $i1 $i2)
			if ((i2!=null?i2.getText():null) != null) {
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:190:27: ^( PARAM[\"p\"] $i1 $i2)
				{
				Object root_1 = (Object)adaptor.nil();
			...
			else // 191:4: -> ^( PARAM[\"p\"] $i1 $t)
			{
				// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:191:7: ^( PARAM[\"p\"] $i1 $t)
				{
				Object root_1 = (Object)adaptor.nil();
				root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(PARAM, "p"), root_1);
				adaptor.addChild(root_1, stream_i1.nextNode());
	...
	// $ANTLR start "type_id"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:194:1: type_id : (i= 'int' |s= 'string' ) ( lvalue2 )* ;
	public final Tiger3Parser.type_id_return type_id() throws RecognitionException {
		...
		Token i=null;
		Token s=null;
		ParserRuleReturnScope lvalue251 =null;

		Object i_tree=null;
		Object s_tree=null;

		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:194:9: ( (i= 'int' |s= 'string' ) ( lvalue2 )* )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:194:11: (i= 'int' |s= 'string' ) ( lvalue2 )*
			{
			root_0 = (Object)adaptor.nil();


			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:194:11: (i= 'int' |s= 'string' )
			int alt44=2;
			...
			switch (alt44) {
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:194:12: i= 'int'
					{
					i=(Token)match(input,63,FOLLOW_63_in_type_id1918); 
					...
					break;
				case 2 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:194:22: s= 'string'
					{
					s=(Token)match(input,67,FOLLOW_67_in_type_id1924); 
			...
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:194:34: ( lvalue2 )*
			loop45:
			while (true) {
				int alt45=2;
				...
				case 1 :
					// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:194:34: lvalue2
					{
					pushFollow(FOLLOW_lvalue2_in_type_id1927);
					lvalue251=lvalue2();
					state._fsp--;

					adaptor.addChild(root_0, lvalue251.getTree());
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:197:1: arrayexp : 'array' ;
	public final Tiger3Parser.arrayexp_return arrayexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:197:10: ( 'array' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:197:12: 'array'
			{
			root_0 = (Object)adaptor.nil();


			string_literal52=(Token)match(input,53,FOLLOW_53_in_arrayexp1938); 
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:198:1: breakexp : 'break' ;
	public final Tiger3Parser.breakexp_return breakexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:198:10: ( 'break' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:198:12: 'break'
			{
			root_0 = (Object)adaptor.nil();


			string_literal53=(Token)match(input,55,FOLLOW_55_in_breakexp1947); 
	...
	// $ANTLR start "doexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:199:1: doexp : 'do' ;
	public final Tiger3Parser.doexp_return doexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:199:8: ( 'do' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:199:10: 'do'
			{
			root_0 = (Object)adaptor.nil();


			string_literal54=(Token)match(input,56,FOLLOW_56_in_doexp1956); 
	...
	// $ANTLR start "elseexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:200:1: elseexp : 'else' ;
	public final Tiger3Parser.elseexp_return elseexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:200:10: ( 'else' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:200:12: 'else'
			{
			root_0 = (Object)adaptor.nil();


			string_literal55=(Token)match(input,57,FOLLOW_57_in_elseexp1966); 
	...
	// $ANTLR start "endexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:201:1: endexp : 'end' ;
	public final Tiger3Parser.endexp_return endexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:201:9: ( 'end' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:201:11: 'end'
			{
			root_0 = (Object)adaptor.nil();


			string_literal56=(Token)match(input,58,FOLLOW_58_in_endexp1977); 
	...
	// $ANTLR start "forexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:202:1: forexp : 'for' ;
	public final Tiger3Parser.forexp_return forexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:202:9: ( 'for' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:202:11: 'for'
			{
			root_0 = (Object)adaptor.nil();


			string_literal57=(Token)match(input,59,FOLLOW_59_in_forexp1987); 
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:203:1: functionexp : 'function' ;
	public final Tiger3Parser.functionexp_return functionexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:203:13: ( 'function' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:203:15: 'function'
			{
			root_0 = (Object)adaptor.nil();


			string_literal58=(Token)match(input,60,FOLLOW_60_in_functionexp1996); 
	...
	// $ANTLR start "ifexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:204:1: ifexp : 'if' ;
	public final Tiger3Parser.ifexp_return ifexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:204:7: ( 'if' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:204:9: 'if'
			{
			root_0 = (Object)adaptor.nil();


			string_literal59=(Token)match(input,61,FOLLOW_61_in_ifexp2004); 
	...
	// $ANTLR start "inexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:205:1: inexp : 'in' ;
	public final Tiger3Parser.inexp_return inexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:205:7: ( 'in' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:205:9: 'in'
			{
			root_0 = (Object)adaptor.nil();


			string_literal60=(Token)match(input,62,FOLLOW_62_in_inexp2013); 
	...
	// $ANTLR start "nilexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:206:1: nilexp : 'nil' ;
	public final Tiger3Parser.nilexp_return nilexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:206:8: ( 'nil' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:206:10: 'nil'
			{
			root_0 = (Object)adaptor.nil();


			string_literal61=(Token)match(input,65,FOLLOW_65_in_nilexp2022); 
	...
	// $ANTLR start "letexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:207:1: letexp : 'let' ;
	public final Tiger3Parser.letexp_return letexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:207:8: ( 'let' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:207:10: 'let'
			{
			root_0 = (Object)adaptor.nil();


			string_literal62=(Token)match(input,64,FOLLOW_64_in_letexp2031); 
	...
	// $ANTLR start "ofexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:208:1: ofexp : 'of' ;
	public final Tiger3Parser.ofexp_return ofexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:208:7: ( 'of' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:208:9: 'of'
			{
			root_0 = (Object)adaptor.nil();


			string_literal63=(Token)match(input,66,FOLLOW_66_in_ofexp2040); 
	...
	// $ANTLR start "thenexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:209:1: thenexp : 'then' ;
	public final Tiger3Parser.thenexp_return thenexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:209:9: ( 'then' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:209:11: 'then'
			{
			root_0 = (Object)adaptor.nil();


			string_literal64=(Token)match(input,68,FOLLOW_68_in_thenexp2049); 
	...
	// $ANTLR start "toexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:210:1: toexp : 'to' ;
	public final Tiger3Parser.toexp_return toexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:210:7: ( 'to' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:210:9: 'to'
			{
			root_0 = (Object)adaptor.nil();


			string_literal65=(Token)match(input,69,FOLLOW_69_in_toexp2057); 
	...
	// $ANTLR start "typeexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:211:1: typeexp : 'type' ;
	public final Tiger3Parser.typeexp_return typeexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:211:9: ( 'type' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:211:11: 'type'
			{
			root_0 = (Object)adaptor.nil();


			string_literal66=(Token)match(input,70,FOLLOW_70_in_typeexp2066); 
	...
	// $ANTLR start "varexp"
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:212:1: varexp : 'var' ;
	public final Tiger3Parser.varexp_return varexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:212:8: ( 'var' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:212:10: 'var'
			{
			root_0 = (Object)adaptor.nil();


			string_literal67=(Token)match(input,72,FOLLOW_72_in_varexp2074); 
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:213:1: whileexp : 'while' ;
	public final Tiger3Parser.whileexp_return whileexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:213:10: ( 'while' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:213:12: 'while'
			{
			root_0 = (Object)adaptor.nil();


			string_literal68=(Token)match(input,73,FOLLOW_73_in_whileexp2083); 
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:214:1: typedefexp : 'typedef' ;
	public final Tiger3Parser.typedefexp_return typedefexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:214:13: ( 'typedef' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:214:15: 'typedef'
			{
			root_0 = (Object)adaptor.nil();


			string_literal69=(Token)match(input,71,FOLLOW_71_in_typedefexp2092); 
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:215:1: blockexp : 'block' ;
	public final Tiger3Parser.blockexp_return blockexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:215:11: ( 'block' )
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:215:13: 'block'
			{
			root_0 = (Object)adaptor.nil();


			string_literal70=(Token)match(input,54,FOLLOW_54_in_blockexp2102); 
	...
	// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:216:1: addminexp : ( '+' | '-' );
	public final Tiger3Parser.addminexp_return addminexp() throws RecognitionException {
		...
		try {
			// D:\\Programmation\\albert22u\\Analyse_lexicale_et_syntaxique\\Tiger3.g:216:11: ( '+' | '-' )
	...
	public static final BitSet FOLLOW_type_id_in_expr149 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000400L});
	public static final BitSet FOLLOW_74_in_expr153 = new BitSet(new long[]{0x0000000000040000L,0x0000000000001000L});
	public static final BitSet FOLLOW_field_list_in_expr155 = new BitSet(new long[]{0x0000000000040000L,0x0000000000001000L});
	public static final BitSet FOLLOW_76_in_expr158 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_letexp_in_expr187 = new BitSet(new long[]{0x5000000000000000L,0x0000000000000140L});
	public static final BitSet FOLLOW_declaration_list_in_expr192 = new BitSet(new long[]{0x4000000000000000L});
	public static final BitSet FOLLOW_inexp_in_expr196 = new BitSet(new long[]{0xAC80021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_seq_in_expr200 = new BitSet(new long[]{0x0400000000000000L});
	public static final BitSet FOLLOW_endexp_in_expr204 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expr_in_expr_list243 = new BitSet(new long[]{0x0000010000000002L});
	public static final BitSet FOLLOW_40_in_expr_list246 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_list_in_expr_list250 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expr_in_expr_seq278 = new BitSet(new long[]{0x0000400000000002L});
	public static final BitSet FOLLOW_46_in_expr_seq284 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_seq_in_expr_seq290 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_field_list317 = new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_field_list319 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_field_list323 = new BitSet(new long[]{0x0000010000000002L});
	public static final BitSet FOLLOW_40_in_field_list328 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_field_list_in_field_list332 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ifexp_in_ifop382 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_ifop386 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000010L});
	public static final BitSet FOLLOW_thenexp_in_ifop392 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_ifop398 = new BitSet(new long[]{0x0200000000000002L});
	public static final BitSet FOLLOW_elseexp_in_ifop405 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_ifop411 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_forexp_in_forop466 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_ID_in_forop470 = new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_forop472 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_forop476 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000020L});
	public static final BitSet FOLLOW_toexp_in_forop478 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_forop482 = new BitSet(new long[]{0x0100000000000000L});
	public static final BitSet FOLLOW_doexp_in_forop486 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_forop492 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_whileexp_in_whileop543 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_whileop547 = new BitSet(new long[]{0x0100000000000000L});
	public static final BitSet FOLLOW_doexp_in_whileop551 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_whileop557 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_orop_in_affect594 = new BitSet(new long[]{0x0000200000000002L});
	public static final BitSet FOLLOW_45_in_affect599 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_affect603 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_andop_in_orop643 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000800L});
	public static final BitSet FOLLOW_75_in_orop648 = new BitSet(new long[]{0x0000021020240000L});
	public static final BitSet FOLLOW_andop_in_orop651 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000800L});
	public static final BitSet FOLLOW_comp_in_andop666 = new BitSet(new long[]{0x0000000800000002L});
	public static final BitSet FOLLOW_35_in_andop671 = new BitSet(new long[]{0x0000021020240000L});
	public static final BitSet FOLLOW_comp_in_andop674 = new BitSet(new long[]{0x0000000800000002L});
	public static final BitSet FOLLOW_binary_in_comp688 = new BitSet(new long[]{0x0003800000000002L});
	public static final BitSet FOLLOW_49_in_comp694 = new BitSet(new long[]{0x0001021020240000L});
	public static final BitSet FOLLOW_48_in_comp698 = new BitSet(new long[]{0x0000021020240000L});
	public static final BitSet FOLLOW_47_in_comp706 = new BitSet(new long[]{0x0003021020240000L});
	public static final BitSet FOLLOW_49_in_comp711 = new BitSet(new long[]{0x0000021020240000L});
	public static final BitSet FOLLOW_48_in_comp717 = new BitSet(new long[]{0x0000021020240000L});
	public static final BitSet FOLLOW_48_in_comp725 = new BitSet(new long[]{0x0000021020240000L});
	public static final BitSet FOLLOW_binary_in_comp730 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_binary2_in_binary871 = new BitSet(new long[]{0x0000028000000002L});
	public static final BitSet FOLLOW_addminexp_in_binary874 = new BitSet(new long[]{0x0000021020240000L});
	public static final BitSet FOLLOW_binary2_in_binary879 = new BitSet(new long[]{0x0000028000000002L});
	public static final BitSet FOLLOW_neg_in_binary2894 = new BitSet(new long[]{0x0000084000000002L});
	public static final BitSet FOLLOW_38_in_binary2900 = new BitSet(new long[]{0x0000021020240000L});
	public static final BitSet FOLLOW_43_in_binary2905 = new BitSet(new long[]{0x0000021020240000L});
	public static final BitSet FOLLOW_neg_in_binary2909 = new BitSet(new long[]{0x0000084000000002L});
	public static final BitSet FOLLOW_41_in_neg923 = new BitSet(new long[]{0x0000001020240000L});
	public static final BitSet FOLLOW_atom_in_neg928 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_36_in_atom963 = new BitSet(new long[]{0xA880023020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_seq_in_atom967 = new BitSet(new long[]{0x0000002000000000L});
	public static final BitSet FOLLOW_37_in_atom970 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_ID_in_lvalue1017 = new BitSet(new long[]{0x0004041000000002L,0x0000000000000400L});
	public static final BitSet FOLLOW_lvalue2_in_lvalue1022 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_36_in_lvalue1028 = new BitSet(new long[]{0xA880023020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_list_in_lvalue1032 = new BitSet(new long[]{0x0000002000000000L});
	public static final BitSet FOLLOW_37_in_lvalue1035 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_74_in_lvalue1041 = new BitSet(new long[]{0x0000000000040000L,0x0000000000001000L});
	public static final BitSet FOLLOW_field_list_in_lvalue1045 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_76_in_lvalue1048 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_42_in_lvalue21140 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_ID_in_lvalue21142 = new BitSet(new long[]{0x0004040000000002L});
	public static final BitSet FOLLOW_lvalue2_in_lvalue21146 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_50_in_lvalue21164 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_lvalue21168 = new BitSet(new long[]{0x0008000000000000L});
	public static final BitSet FOLLOW_51_in_lvalue21170 = new BitSet(new long[]{0x0004040000000002L,0x0000000000000004L});
	public static final BitSet FOLLOW_lvalue2_in_lvalue21175 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ofexp_in_lvalue21181 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_lvalue21185 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_declaration_in_declaration_list1255 = new BitSet(new long[]{0x1000000000000002L,0x0000000000000140L});
	...
	public static final BitSet FOLLOW_typeexp_in_type_declaration1311 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_ID_in_type_declaration1315 = new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_type_declaration1317 = new BitSet(new long[]{0x8010000000040000L,0x0000000000000408L});
	public static final BitSet FOLLOW_type_in_type_declaration1321 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_type1349 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_id_in_type1355 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_74_in_type1386 = new BitSet(new long[]{0x0000000000040000L,0x0000000000001000L});
	public static final BitSet FOLLOW_type_fields_in_type1390 = new BitSet(new long[]{0x0000000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_76_in_type1393 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_52_in_type1423 = new BitSet(new long[]{0x8000000000040000L,0x0000000000000008L});
	public static final BitSet FOLLOW_type_id_in_type1428 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_type1434 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_varexp_in_variable_declaration1474 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_ID_in_variable_declaration1478 = new BitSet(new long[]{0x0000300000000000L});
	public static final BitSet FOLLOW_44_in_variable_declaration1484 = new BitSet(new long[]{0x8000000000040000L,0x0000000000000008L});
	public static final BitSet FOLLOW_ID_in_variable_declaration1489 = new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_type_id_in_variable_declaration1495 = new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_variable_declaration1500 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_variable_declaration1504 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_functionexp_in_function_declaration1578 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_ID_in_function_declaration1580 = new BitSet(new long[]{0x0000001000000000L});
	public static final BitSet FOLLOW_36_in_function_declaration1582 = new BitSet(new long[]{0x0000002000040000L});
	public static final BitSet FOLLOW_type_fields_in_function_declaration1586 = new BitSet(new long[]{0x0000002000000000L});
	public static final BitSet FOLLOW_37_in_function_declaration1589 = new BitSet(new long[]{0x0001100000000000L});
	public static final BitSet FOLLOW_44_in_function_declaration1592 = new BitSet(new long[]{0x8000000000040000L,0x0000000000000008L});
	public static final BitSet FOLLOW_type_id_in_function_declaration1597 = new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_ID_in_function_declaration1601 = new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_function_declaration1607 = new BitSet(new long[]{0xA880021020240000L,0x000000000000020BL});
	public static final BitSet FOLLOW_expr_in_function_declaration1614 = new BitSet(new long[]{0xA880021020240002L,0x000000000000020BL});
	public static final BitSet FOLLOW_type_field_in_type_fields1798 = new BitSet(new long[]{0x0000010000000002L});
	public static final BitSet FOLLOW_type_fields2_in_type_fields1802 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_40_in_type_fields21826 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_type_field_in_type_fields21830 = new BitSet(new long[]{0x0000010000000002L});
	public static final BitSet FOLLOW_type_fields2_in_type_fields21834 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_type_field1860 = new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_44_in_type_field1862 = new BitSet(new long[]{0x8000000000040000L,0x0000000000000008L});
	public static final BitSet FOLLOW_type_id_in_type_field1867 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_type_field1871 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_63_in_type_id1918 = new BitSet(new long[]{0x0004040000000002L});
	public static final BitSet FOLLOW_67_in_type_id1924 = new BitSet(new long[]{0x0004040000000002L});
	public static final BitSet FOLLOW_lvalue2_in_type_id1927 = new BitSet(new long[]{0x0004040000000002L});
	public static final BitSet FOLLOW_53_in_arrayexp1938 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_55_in_breakexp1947 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_56_in_doexp1956 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_57_in_elseexp1966 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_58_in_endexp1977 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_59_in_forexp1987 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_60_in_functionexp1996 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_61_in_ifexp2004 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_62_in_inexp2013 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_65_in_nilexp2022 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_64_in_letexp2031 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_66_in_ofexp2040 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_68_in_thenexp2049 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_69_in_toexp2057 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_70_in_typeexp2066 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_72_in_varexp2074 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_73_in_whileexp2083 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_71_in_typedefexp2092 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_54_in_blockexp2102 = new BitSet(new long[]{0x0000000000000002L});
}
